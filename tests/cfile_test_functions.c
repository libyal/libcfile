...
{
	static char *function     = "cfile_test_get_narrow_source";
...
int cfile_test_get_wide_source(
     ...
     libcerror_error_t **error )
{
	static char *function   = "cfile_test_get_wide_source";
...
int cfile_test_get_temporary_filename(
     ...
     libcerror_error_t **error )
{
	static char *function = "cfile_test_get_temporary_filename";
...
int cfile_test_get_temporary_filename_wide(
     ...
     libcerror_error_t **error )
{
	static char *function     = "cfile_test_get_temporary_filename_wide";

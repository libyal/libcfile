/*
 * Cross-platform C file functions library stream read testing program
 *
...
#define CFILE_TEST_STREAM_READ_BUFFER_SIZE	4096

/* Tests libcfile_stream_get_offset
...
{
	uint8_t buffer[ CFILE_TEST_STREAM_READ_BUFFER_SIZE ];
	...
	{
		read_size = CFILE_TEST_STREAM_READ_BUFFER_SIZE;

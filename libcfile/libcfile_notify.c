...
{
	static char *function = "libcfile_notify_set_stream";
...
int libcfile_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libcfile_notify_stream_open";
...
int libcfile_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libcfile_notify_stream_close";
